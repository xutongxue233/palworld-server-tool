...
func RegisterRouter(r *gin.Engine) {
	...
	authGroup.Use(auth.JWTAuthMiddleware())
	{
		...
		authGroup.GET("/server/mods", getOfficialMods)
		authGroup.POST("/server/mods/preflight", preflightOfficialModSettings)
		authGroup.POST("/server/mods/apply", applyOfficialModSettings)
