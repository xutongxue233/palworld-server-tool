...
const messages = {
  en: {
    ...
    message: {
      ...
      settingsfail: "Failed to load server settings: {err}",
      saveworldtip: "Save the current world data now?",
      saveworldsuccess: "World saved successfully!",
      saveworldfail: "Failed to save world: {err}",
      forcestoptip:
        "Force stop skips the graceful shutdown delay and may risk losing recent data. Continue?",
      forcestopsuccess: "Force stop command sent!",
      forcestopfail: "Failed to force stop server: {err}",
  ...
  zh: {
    ...
    message: {
      ...
      settingsfail: "读取服务器设置失败: {err}",
      saveworldtip: "立即保存当前世界数据吗？",
      saveworldsuccess: "世界保存成功！",
      saveworldfail: "世界保存失败: {err}",
      forcestoptip:
        "强制停止不会等待平滑关服，可能丢失最近的数据。确定继续吗？",
      forcestopsuccess: "已发送强制停止命令！",
      forcestopfail: "强制停止失败: {err}",
  ...
  ja: {
    ...
    message: {
      ...
      settingsfail: "サーバー設定の取得に失敗しました: {err}",
      saveworldtip: "現在のワールドデータを保存しますか？",
      saveworldsuccess: "ワールドを保存しました！",
      saveworldfail: "ワールドの保存に失敗しました: {err}",
      forcestoptip:
        "強制停止は通常の終了処理を行わないため、直近のデータが失われる可能性があります。続行しますか？",
      forcestopsuccess: "強制停止コマンドを送信しました！",
      forcestopfail: "サーバーの強制停止に失敗しました: {err}",
